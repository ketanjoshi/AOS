...
public class Globals {
    ...
    public static HashSet<Integer> markersReceived = new HashSet<Integer>();
    ...
    public static synchronized boolean isAllStaleMarkersReceived() {
    	return (markersReceivedSoFar % neighborCount) == 0;
    }
}
